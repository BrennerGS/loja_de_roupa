...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="<?php echo e(route('sales.store')); ?>" method="POST" x-data="saleForm()">
        <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select id="client_id" name="client_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($client->id); ?>"><?php echo e($client->name); ?> (<?php echo e($client->phone); ?>)</option>
                    ...
                    <div class="flex space-x-2">
                        <select x-model="selectedProduct" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                >
                                    <?php echo e($product->name); ?> (<?php echo e($product->sku); ?>) - R$ <?php echo e(number_format($product->price, 2, ',', '.')); ?> | Estoque: <?php echo e($product->quantity); ?>
...
document.addEventListener('alpine:init', () => {
    const products = <?php echo json_encode($products->map(function($product) {
            return [
                'id' => $product->id, 'stock' => $product->quantity
            ];
        }), 512) ?>;
...
<?php echo $__env->make('layouts.app', ['title' => 'Nova Venda'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Herd\loja_de_roupa\resources\views/sales/create.blade.php ENDPATH**/ ?>