                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-sm text-gray-500"><?php echo e($user->is_admin ? 'Administrador' : 'Usuário'); ?></div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-wrap gap-1">
                            <?php $__currentLoopData = $user->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="bg-gray-100 px-2 py-1 rounded text-xs"><?php echo e($permission->name); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button onclick="openModal('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>', <?php echo e($user->permissions->pluck('id')); ?>)" 
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form id="permissionForm" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="perm_<?php echo e($permission->id); ?>" name="permissions[]" value="<?php echo e($permission->id); ?>"
                                   class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                            <label for="perm_<?php echo e($permission->id); ?>" class="ml-2 block text-sm text-gray-900">
...
<?php echo $__env->make('layouts.app', ['title' => 'Usuários e Permissões'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Herd\loja_de_roupa\resources\views/settings/users.blade.php ENDPATH**/ ?>