    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="p-4">
                ...
                <a href="{{ route('reports.sales') }}" class="text-indigo-600 hover:text-indigo-800 font-medium flex items-center">
        ...
        <div class="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="p-4">
                ...
                <a href="{{ route('reports.products') }}" class="text-green-600 hover:text-green-800 font-medium flex items-center">
                    Acessar Relatório <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
        </div>
        ...
        <div class="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="p-4">
                ...
                <a href="{{ route('reports.clients') }}" class="text-purple-600 hover:text-purple-800 font-medium flex items-center">
                    Acessar Relatório <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
        </div>
